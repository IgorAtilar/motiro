...
export default function EditShoppingList() {
  const [items, setItems] = useState([
    { value: 'Arroz 2 pacotes', id: Math.random().toString() },
    { value: 'Feijão 1 pacote', id: Math.random().toString() },
    { value: 'Carne 1kg', id: Math.random().toString() },
  ]);
  const [title, setTitle] = useState<string>('Lista de compras');
  const [description, setDescription] = useState<string>('Compras do mês');
          ...
          >
            ...
            >
              ...
              <TouchableOpacity style={styles.createButton}>
                <BodyText style={styles.createButtonText}>Editar</BodyText>
              </TouchableOpacity>
            </ScrollView>
          </KeyboardAvoidingView>
        </TouchableWithoutFeedback>
